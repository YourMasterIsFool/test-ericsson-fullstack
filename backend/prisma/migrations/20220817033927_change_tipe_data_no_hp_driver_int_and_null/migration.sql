/*
  ...
  - You are about to alter the column `no_hp_driver` on the `Shipment` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
